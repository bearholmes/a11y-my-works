/**
 * account_id 기반으로 일관된 배경색을 생성하고 WCAG AA 기준 명도대비를 만족하는 텍스트 색상을 반환하는 유틸리티
 */

/**
 * 문자열을 해시 값으로 변환
 * @param str - 해시할 문자열 (account_id)
 ...
 * @param l1 - 첫 번째 색상의 상대 휘도
 * @param l2 - 두 번째 색상의 상대 휘도
 * @returns 명도 대비 비율
 */
 ...
 * @param bgR - 배경색 Red (0-255)
 * @param bgG - 배경색 Green (0-255)
 * @param bgB - 배경색 Blue (0-255)
 * @returns 텍스트 색상 ("#ffffff" 또는 "#000000")
 */
